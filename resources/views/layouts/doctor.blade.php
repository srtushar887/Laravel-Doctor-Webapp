        ...
        <div data-simplebar class="h-100">
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('doctor.dashboard')}}" class="waves-effect"><i class="mdi mdi-home-analytics"></i>
                            <span>Dashboard</span></a>
                    </li>

                    <li>
                        <a href="{{route('doctor.medicine')}}" class="waves-effect"><i class="mdi mdi-home-analytics"></i>
                            <span>Medicine</span></a>
                    </li>

                    <li>
                        <a href="{{route('doctor.diagnosis')}}" class="waves-effect"><i class="mdi mdi-home-analytics"></i>
                            <span>Diagnosis</span></a>
                    </li>

                    <li>
                        <a href="{{route('doctor.examination')}}" class="waves-effect"><i class="mdi mdi-home-analytics"></i>
